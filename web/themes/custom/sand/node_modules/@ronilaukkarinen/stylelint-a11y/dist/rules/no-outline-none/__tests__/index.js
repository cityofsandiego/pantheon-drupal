...
testRule({
  ...
  reject: [{
    ...
    message: _index.messages.expected('.foo1:focus'),
    line: 1,
    column: 3
  }, {
    code: '.bar:focus { outline: none; }',
    message: _index.messages.expected('.bar:focus'),
    line: 1,
    column: 3
  }, {
    code: '.baz:focus { outline: none; border: transparent; }',
    message: _index.messages.expected('.baz:focus'),
    line: 1,
    column: 3
  }, {
    code: '.quux { .quuux:focus { outline: 0; } }',
    message: _index.messages.expected('.quuux:focus'),
    line: 1,
    column: 11
  }]
});