      ...
      menu : function() {
        ...
        $(window).on('resize', function(){
          ...
          // console.log ( windowWidth );
            // We were getting the error TypeError: undefined is not an object (evaluating 'e.nodeType') on citynet
            // so added the check for undefined. This has been done previously in offcanvas.js. See github issue #569.
...
// Drupal.behaviors.sand = {
//   attach() {
//     function ElevatorModule(window, document, undefined) {
//       var Elevator = {
//         init : function() {
//           $(document).ready(function() {
//             Elevator.utils.init();
