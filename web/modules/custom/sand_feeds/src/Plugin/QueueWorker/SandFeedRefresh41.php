 ...
 *
 * @QueueWorker(
 *   id = "sand_feeds_feed_refresh_id:41",
 *   title = @Translation("Sand Feed Refresh ID:41 - Doc scs_council_reso_ordinance 1986_1995"),
 *   cron = {"time" = 321},
 * )
 */
class SandFeedRefresh41 extends FeedRefresh {
