 ...
 *
 * @QueueWorker(
 *   id = "sand_feeds_feed_refresh_id:42",
 *   title = @Translation("Sand Feed Refresh ID:42 - Doc scs_council_reso_ordinance 1996_2005"),
 *   cron = {"time" = 321},
 * )
 */
class SandFeedRefresh42 extends FeedRefresh {
