...
//layout elements
var pageheader="Smart Growth and Land Use Committee";
...
var newsearch = '<p><a href="https://google.sannet.gov/search?partialfields=&proxyreload=1&num=100&requiredfields=PATH%3Accaction_sglu%7CPATH%3Accagenda_sglu&layout_type=date_subsort&getfields=DOCUMENT_URL.DOC_DATE.TITLE.SORTORDER&sort=date%3AD%3AS%3Ad1&output=xml_no_dtd&ie=UTF-8&client=scs_ocd&filter=0&site=documents&config=sglu.js&proxystylesheet=scs_ocd&q=">Try another search</a>.<br><strong>2015 documents will display when available.</strong></p>';
var previousyears = '';

//hidden parameters used in the search form
var sort='<input type="hidden" name="sort" value="">';
var requiredfields="PATH:ccaction_sglu|PATH:ccagenda_sglu";
var site="documents";
