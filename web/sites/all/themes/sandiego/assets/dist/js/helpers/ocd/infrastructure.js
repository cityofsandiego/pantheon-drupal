...
var config="infrastructure.js";

//layout elements
var pageheader="Infrastructure Committee";
...
var newsearch = '<p><a href="https://google.sannet.gov/search?partialfields=&proxyreload=1&num=100&requiredfields=PATH%3Accaction_infrastructure%7CPATH%3Accagenda_infrastructure&layout_type=date_subsort&getfields=DOCUMENT_URL.DOC_DATE.TITLE.SORTORDER&sort=date%3AD%3AS%3Ad1&output=xml_no_dtd&ie=UTF-8&client=scs_ocd&filter=0&site=documents&config=infrastructure.js&proxystylesheet=scs_ocd&q=">Try another search</a></p>';
var previousyears = '';

//hidden parameters used in the search form
var sort='<input type="hidden" name="sort" value="">';
var requiredfields="PATH:ccaction_infrastructure|PATH:ccagenda_infrastructure";
var site="documents";
