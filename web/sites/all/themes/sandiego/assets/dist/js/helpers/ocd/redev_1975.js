...
var config="redev_1975.js";

//layout elements
var pageheader="1975 Redevelopment Agency Agendas, Minutes &amp; Reports";
...
var newsearch = '<p><a href="https://google.sannet.gov/search?partialfields=&proxyreload=1&num=100&requiredfields=YEAR%3A1975&layout_type=report&getfields=DOC_DATE.DOC_NUM.TITLE&sort=date%3AD%3AS%3Ad1&output=xml_no_dtd&ie=UTF-8&client=scs_ocd&filter=0&site=scs_redevelopment&config=redev_1975.js&proxystylesheet=scs_ocd&q=">Try another search</a>.</p>';
var previousyears = '';

//hidden parameters used in the search form
var sort='<input type="hidden" name="sort" value="">';
var requiredfields="YEAR:1975";
