...
//layout elements
var pageheader="Rules and Economic Development Committee";
...
var newsearch = '<p><a href="https://google.sannet.gov/search?partialfields=&proxyreload=1&num=100&requiredfields=PATH%3Accaction_rules_ogir%7CPATH%3Accagenda_rules_ogir&layout_type=date_subsort&getfields=DOCUMENT_URL.DOC_DATE.TITLE.SORTORDER&sort=date%3AD%3AS%3Ad1&output=xml_no_dtd&ie=UTF-8&client=scs_ocd&filter=0&site=documents&config=rules.js&proxystylesheet=scs_ocd&q">Try another search</a>.</p>';
var previousyears = '';

//hidden parameters used in the search form
var sort='<input type="hidden" name="sort" value="">';
var requiredfields="PATH:ccaction_rules_ogir|PATH:ccagenda_rules_ogir";
var site="documents";
