...
var config="rprtstocouncil_2014.js";

//layout elements
var pageheader="2014 Reports to the City Council";
...
var content = '<p><strong>Specific Field Search</strong>  - An <a href="http://www.sandiego.gov/city-clerk/officialdocs/legisdocs/ccreports/councilreportsadvanced.shtml">Advanced Search</a> provides specific field search options for Reports to the City Council.</p><p>Reports to the City Council are significant City government documents that transmit information and recommendations to the City Council or to City Council standing committees.  <a href="http://www.sandiego.gov/city-clerk/officialdocs/legisdocs/aboutreports.shtml">More Details about Reports to the City Council...</a></p>';
var newsearch = '<p><a href="https://google.sannet.gov/search?partialfields=&sort=date%3AD%3AS%3Ad1&proxyreload=1&num=100&requiredfields=PATH%3A2014&layout_type=3colnumlink&getfields=DOC_NUM.DOC_DATE.TITLE&output=xml_no_dtd&ie=UTF-8&client=scs_ocd&filter=0&site=scs_reportstocouncil&config=reportstocouncil.js&proxystylesheet=scs_ocd">Try another search</a>.</p>';
var previousyears = '<p><a href="' + url + '/city-clerk/officialdocs/legisdocs/ccreports/councilpreviousreports.shtml">View Previous Years\' Reports</a></p>';
