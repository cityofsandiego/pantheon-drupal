...
var config="sirecouncilmeetings_test.js";
...
var colwidths="150";
content = '<p>The Council meeting minutes will be posted on the web after being approved by the City Council. Please check the City Council Results sheet for a summary of the meeting.</p><p>City Council meetings are held Monday and Tuesday of every week except during scheduled Legislative Recesses.  The meetings can be watched on <a href="http://www.sandiego.gov/citytv/">CityTV</a> - Channel 24 on Cox Communications and Time Warner Cable within the San Diego City limits or via <a href="http://www.sandiego.gov/citytv/webstreaming/index.shtml">live webcast</a>.  Below you will find links to <a href="' + url + '/city-clerk/officialdocs/legisdocs/councildocuments.shtml">City Council meeting documents</a>, published for each meeting.  <a href="http://www.sandiego.gov/city-clerk/councilcomm/closedsess/index.shtml">Closed Session Reports</a> are also available for download.</p><h4>Annual Legislative Calendar</h4><p><a href="http://www.sandiego.gov/city-clerk/pdf/legiscal.pdf">2010</a></p><p>If you are interested in expressing your interest or comments about an item to be discussed by the City Council in an upcoming meeting, please feel free to complete our <a href="'+ url + '/city-clerk/officialdocs/docketcomment.shtml">Public Comment Form</a>.</p>';
var newsearch = '<p><a href="https://google.sannet.gov/search?partialfields=&proxyreload=1&num=100&requiredfields=PATH%3Acouncildockets%7CPATH%3Acouncilminutes%7CPATH%3Acouncilresults&getfields=DOCUMENT_URL.DOC_DATE.TITLE.SORTORDER&sort=date%3AD%3AS%3Ad1&output=xml_no_dtd&ie=UTF-8&client=scs_ocd&filter=0&site=documents&config=sirecouncilmeetings_test.js&proxystylesheet=sirefrontend_test&q=Council+inmeta:DOC_DATE_NUM%3A20090101..20100101">Try another search</a>.</p>';
var previousyears = '<p><a href="' + url + '/city-clerk/officialdocs/legisdocs/previous.shtml">View Previous Years\' Listings</a></p>';
