...
var config="siredockets_att.js";

//layout elements
var pageheader="2008 City Council Meeting Docket (Agenda) Attachments";
...
var content =  '<b><i><font color="red">This list of attachments is for internal reference only.</font></i></b><p>'
               ...
               + '<li><b>Add the Documentum subfolder, for example:</b> 2008/January/'
               + '<li><b>Add the file name, for example:</b> 01-07-2008_Item_251'
               ...
               + '<nobr>http://docs.sandiego.gov/councildockets_attach/2008/January/01-07-2008_Item_251.pdf</nobr><p>'
               + '<p><a href="https://google.sannet.gov/search?partialfields=&sort=date%3AD%3AS%3Ad1&proxyreload=1&num=100&requiredfields=PATH%3Acouncildockets_attach&layout_type=list&getfields=TITLE&output=xml_no_dtd&ie=UTF-8&client=scs_ocd&filter=0&site=scs_docketattach_2007&config=dockets_att_all.js&proxystylesheet=scs_ocd&q=">Prior year\'s attachments</a></p>';
