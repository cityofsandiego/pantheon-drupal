...
var config="budget.js";

//layout elements
var pageheader="Budget and Finance Committee (B&F)";
...
var newsearch = '<p><a href="https://google.sannet.gov/search?partialfields=&proxyreload=1&num=100&requiredfields=PATH%3Accaction_budgetfinance%7CPATH%3Accagenda_budgetfinance&layout_type=date_subsort&getfields=DOCUMENT_URL.DOC_DATE.TITLE.SORTORDER&sort=date%3AD%3AS%3Ad1&output=xml_no_dtd&ie=UTF-8&client=scs_ocd&filter=0&site=documents&config=budget.js&proxystylesheet=scs_ocd&q=">Try another search</a>.</p>';
var previousyears = '<p><a href="' + url + '/city-clerk/councilcomm/fy14budgetprocess130215.pdf">Fiscal Year 2014 Budget Process- KEY DATES</a></p>';

//hidden parameters used in the search form
var sort='<input type="hidden" name="sort" value="">';
var requiredfields="PATH:ccaction_budgetfinance|PATH:ccagenda_budgetfinance";
var site="documents";
