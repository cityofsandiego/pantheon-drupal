...
var library = new google.maps.MarkerImage('/sites/default/files/legacy/public-library/graphics/library.png');
...
function initialize() {
  ...
  google.maps.event.addListener(map, 'click', function() {
      ...
      downloadUrl("/sites/default/files/librarylocations.xml", function(doc) {
        ...
        for (var i = 0; i < markers.length; i++) {
		  ...
		  if (facebook && twitter){
			var html1= "<strong>" + branch + " Library</strong><br>" + addr1 + "<br>" + addr2 + "<p>" + phone + "&nbsp;&nbsp;<a href='http://twitter.com/" + twitter + "'><img src='/sites/default/files/legacy/public-library/graphics/twittericon.png' width='25' height='25' alt='" + branch + " twitter link' border='0' align='top'></a>&nbsp;&nbsp;<a href='http://www.facebook.com/" + facebook + "'><img src='/sites/default/files/legacy/graphics/facebookicon.png' width='25' height='25' alt='" + branch + " facebook link' border='0' align='top'></a><br><p align='center'><img src='/sites/default/files/legacy/public-library/graphics/branches/" + photo + "' width='150' height='113' alt='" + branch + " image' border='0'><br><a href='http://maps.google.com/maps?saddr=&daddr=" + addr1 + " San Diego, CA' target ='_blank'>Directions</a></p>";
			}	
		  else if (facebook){
			var html1= "<strong>" + branch + " Library</strong><br>" + addr1 + "<br>" + addr2 + "<p>" + phone + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='http://www.facebook.com/" + facebook + "'><img src='/sites/default/files/legacy/graphics/facebookicon.png' width='25'  height='25' alt='" + branch + " facebook link' border='0' align='top'></a><br><p align='center'><img src='/sites/default/files/legacy/public-library/graphics/branches/" + photo + "' width='150' height='113' alt='" + branch + " image' border='0'><br><a href='http://maps.google.com/maps?saddr=&daddr=" + addr1 + " San Diego, CA' target ='_blank'>Directions</a></p>";
			}	
	 	  else {
			var html1= "<strong>" + branch + " Library</strong><br>" + addr1 + "<br>" + addr2 + "<p>" + phone + "<br><p align='center'><img src='/sites/default/files/legacy/public-library/graphics/branches/" + photo + "' width='150' height='113' alt='" + branch + " image' border='0'><br><a href='http://maps.google.com/maps?saddr=&daddr=" +  addr1 + " San Diego, CA' target ='_blank'>Directions</a></p>";
			}
          // create the marker
